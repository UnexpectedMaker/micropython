...
May 3, 2025 - Modified by Unexpected Maker
    
Library was updated to allow for an IO Expander to be passed in for the reset pin in the reset() function for use on SQUiXL.
https://squixl.io 
    
Thanks to OpenMV for providing this awesome library.
...
class GT911:
    def __init__(
        ...
        self.rst_pin = reset_pin
        self.irq_pin = None
        self.irq_pin_label = irq_pin
        self.ioex = ioex

        self.ioex.pin_mode(self.rst_pin, 0, 0)
    ...
    def reset(self):
        ...
        self.ioex.write(self.rst_pin, 0)
        # self.rst_pin(0)
        sleep_ms(10)
        self.irq_pin = Pin(self.irq_pin_label, Pin.OUT, value=0)
        sleep_ms(50)
        self.ioex.write(self.rst_pin, 1)
