...
// ------------------------------------------------------------------
// Enable machine.RGB on S3 only - added by Seon
#ifndef MICROPY_PY_MACHINE_RGB
#define MICROPY_PY_MACHINE_RGB (CONFIG_IDF_TARGET_ESP32S3)
#endif
#define MICROPY_PY_MACHINE_RGB_INCLUDEFILE "ports/esp32/machine_rgb.c"
// ------------------------------------------------------------------
...
#define MICROPY_PY_SOCKET_EVENTS_HANDLER     \
	extern void socket_events_handler(void); \
